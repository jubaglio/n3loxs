...
vpath %.cpp $(WORKINGDIR)/src/dy_w_bins $(WORKINGDIR)/src/dy_gamma_bins $(WORKINGDIR)/src/wh_dynamical
...
OBJ_PHOT_BINS = alphaS_simplified.o pdffunctions.o softvirtual_dy_gamma_bins.o regularterms_bins.o regularterms_gq_bins.o regularterms_gg_bins.o \
	regularterms_qq_bins.o regularterms_q1q2_bins.o regularterms_q1q2b_bins.o regularterms_dy_bins_all.o main_dy_bins_n3lo.o
...
OBJ_WH_DYN = alphaS_simplified.o pdffunctions_w.o softvirtual_dynamical_wh.o regularterms_wh_dynamical_all.o regularterms_w.o \
	 regularterms_gubar.o regularterms_gg_w.o regularterms_gu.o regularterms_cubar.o regularterms_qqbar.o regularterms_qq_w.o \
...
all: run_dy_w run_dy_phot run_wh run_bbh run_ggh run_dy_w_bins run_dy_phot_bins run_wh_dyn

run_dy_phot: $(addprefix ./build/, $(OBJ_PHOT))
	$(CC) $(patsubst %,./build/%,$(OBJ_PHOT)) $(CC2) -o $@
	mv run_dy_phot ./subprogs/

run_dy_phot_bins: $(addprefix ./build/, $(OBJ_PHOT_BINS))
	$(CC) $(patsubst %,./build/%,$(OBJ_PHOT_BINS)) $(CC2) -o $@
	mv run_dy_phot_bins ./subprogs/
