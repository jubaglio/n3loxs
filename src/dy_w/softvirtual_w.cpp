...
********************************************************************* */
  ...
  res = fac*delterms;
  res = res*tau*dlumdub(z,tau/z,muf2,pdf)/z;
  return res;
}
...
********************************************************************* */
  ...
  res = fac*res;
  res = res*tau*dlumdub(x2,tau/x2,muf2,pdf)/x2;
  return res;
}
...
********************************************************************* */
  ...
  res = fac*res;
  res = res*tau*( dlumdub(x2,tau/x1/x2,muf2,pdf)/x1/x2 - dlumdub(x2,tau/x2,muf2,pdf)/x2 );
  return res;
}
