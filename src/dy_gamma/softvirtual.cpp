...
Soft+Virtual contributions for the DY process q qb -> gamma* -> l l up to N3LO QCD
*********************************************************************
********************************************************************* */
...
********************************************************************* */
  ...
  switch(k)
	...
	(684831*constants::Pi4 - 187912*constants::Pi6 - 3240*log3*(33 + 32*constants::Pi2 - 4096*constants::Zeta3) + 
	 ...
	 180*log1*(267*constants::Pi4 + 8*constants::Pi2*(-5773 + 47448*constants::Zeta3) - 
      ...
      udeltermsn3lo = 0.5*(150*constants::Pi2 - constants::Pi4 + 60*(6 + 7*constants::Zeta3 - 40*constants::Zeta5))/1296.0;
      ddeltermsn3lo = -(150*constants::Pi2 - constants::Pi4 + 60*(6 + 7*constants::Zeta3 - 40*constants::Zeta5))/1296.0;
      break;
    }
  ...
  res = fac*delterms;
  res = res*tau*dlumqqb(z,tau/z,muf2,pdf)/z;

  if(k==3)
    {
      res = res + fac*tau/z*(udeltermsn3lo*dlumuub(z,tau/z,muf2,pdf)+ddeltermsn3lo*dlumddb(z,tau/z,muf2,pdf));
    }
  return res;
}
...
********************************************************************* */
  ...
  res = fac*res;
  res = res*tau*dlumqqb(x2,tau/x2,muf2,pdf)/x2;
  return res;
}
...
********************************************************************* */
  ...
  res = fac*res;
  res = res*tau*( dlumqqb(x2,tau/x1/x2,muf2,pdf)/x1/x2 - dlumqqb(x2,tau/x2,muf2,pdf)/x2 );
  return res;
}
