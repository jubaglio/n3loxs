...
Soft+Virtual functions for the DY process q qb -> gamma* / Z -> l l up to N3LO QCD (vector part)
*********************************************************************
********************************************************************* */
...
std::tuple<double, double> delta_kernel(const double log1, const int k)
{
/* *******************************************************************
  ...
  switch(k)
	...
	(684831*constants::Pi4 - 187912*constants::Pi6 - 3240*log3*(33 + 32*constants::Pi2 - 4096*constants::Zeta3) + 
	 ...
	 180*log1*(267*constants::Pi4 + 8*constants::Pi2*(-5773 + 47448*constants::Zeta3) - 
      ...
      deltermsn3lo = (150*constants::Pi2 - constants::Pi4 + 60*(6 + 7*constants::Zeta3 - 40*constants::Zeta5))/1296.0;
      break;
    }

  return std::make_tuple(delterms, deltermsn3lo);
}
...
// PlusConst function
double PlusConst_kernel(const double tau, const double log1, const int k)
{
/* *******************************************************************
***  Declaration of variables 
********************************************************************* */
...
// PlusInt function
double PlusInt_kernel(const double x1, const double log1, const int k)
{
/* *******************************************************************
***  Declaration of variables 
********************************************************************* */
